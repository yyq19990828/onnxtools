...
class VisualizationPreset:
    ...
    label_type: str | None = None  # e.g., "confidence_only" for confidence-only labels

    @classmethod
    def from_yaml(cls, preset_name: str, config_path: str | None = None) -> "VisualizationPreset":
        """
        ...
        for ann_config in preset_data["annotators"]:
            ...
            if "position" in config_copy:
                ...
                if isinstance(position_str, str):
                    ...
                    config_copy["position"] = position_map.get(position_str.upper(), sv.Position.CENTER)
...
def load_preset_cached(preset_name: str, config_path: str | None = None) -> VisualizationPreset:
    """
...
def create_preset_pipeline(preset_name: str, config_path: str | None = None) -> AnnotatorPipeline:
    """
