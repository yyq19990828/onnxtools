...
This module provides the InferencePipeline class (recommended).
...
class InferencePipeline:
    ...
    def _process_frame(self, frame: np.ndarray) -> Tuple[np.ndarray, List[Dict[str, Any]]]:
        ...
        if len(result) > 0:
            ...
            roi_top_pixel = int(h_img * self.roi_top_ratio)
            ...
            plate_conf_thres = self.plate_conf_thres
