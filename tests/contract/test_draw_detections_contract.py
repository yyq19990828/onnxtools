...
class TestDrawDetectionsContract:
    ...
    def test_draw_detections_output_format_contract(
    ...
    def test_draw_detections_ocr_integration_contract(
    ...
    def test_draw_detections_supervision_integration_contract(
        self, sample_image, sample_detections, sample_class_names, sample_colors
    ):
    ...
    def test_chinese_font_support_contract(
        self, sample_image, sample_detections, sample_class_names, sample_colors, sample_plate_results
    ):
        ...
        result = draw_detections(
            sample_image, sample_detections, sample_class_names, sample_colors, plate_results=chinese_plate_results
        )
