...
class TestAnnotatorFactoryContract:
    ...
    def test_create_all_annotator_types(self):
        ...
        default_config = {"color_palette": sv.ColorPalette.DEFAULT, "color_lookup": sv.ColorLookup.CLASS}
        ...
        for ann_type in AnnotatorType:
            ...
            assert hasattr(annotator, "annotate"), f"{ann_type.value} annotator missing 'annotate' method"

    def test_round_box_with_specific_config(self):
        """Test RoundBoxAnnotator with specific configuration."""
        config = {"thickness": 3, "roundness": 0.3, "color_palette": sv.ColorPalette.DEFAULT}
    ...
    def test_percentage_bar_with_custom_config(self):
        ...
        config = {"height": 16, "width": 80, "position": sv.Position.TOP_LEFT}
    ...
    def test_dict_config_support(self):
        ...
        dict_config = {"thickness": 2, "roundness": 0.3}
    ...
    def test_config_object_support(self):
        ...
        config = {"thickness": 2, "corner_length": 20}
    ...
    def test_geometric_annotators_with_position(self):
        ...
        for ann_type in [AnnotatorType.DOT, AnnotatorType.TRIANGLE]:
            config = {"position": sv.Position.CENTER}
    ...
    def test_privacy_annotators(self):
        ...
        blur_annotator = AnnotatorFactory.create(AnnotatorType.BLUR, {"kernel_size": 15})

        pixelate_annotator = AnnotatorFactory.create(AnnotatorType.PIXELATE, {"pixel_size": 20})
