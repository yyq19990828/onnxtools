...
class TestResultFilter:
    ...
    def sample_result(self):
        ...
        return Result(
            boxes=boxes, scores=scores, class_ids=class_ids, orig_img=orig_img, orig_shape=(100, 200), names=names
        )
...
class TestResultCrop:
    ...
    def test_crop_boundary_clipping(self):
        ...
        result = Result(boxes=boxes, scores=scores, class_ids=class_ids, orig_img=orig_img, orig_shape=(100, 100))
...
class TestResultSaveCrop:
    ...
    def test_save_crop_illegal_class_names(self, temp_dir):
        ...
        result = Result(
            boxes=boxes, scores=scores, class_ids=class_ids, orig_img=orig_img, orig_shape=(100, 100), names=names
        )
