...
def main():
    ...
    parser.add_argument("--model-path", type=str, required=True, help="ONNX模型文件路径")
    ...
    parser.add_argument("--max-images", type=int, default=None, help="最大处理图片数量")
    parser.add_argument("--exclude-files", type=str, nargs="*", default=None, help="需要排除的文件列表")
    parser.add_argument(
        "--exclude-labels-containing", type=str, nargs="*", default=None, help="需要排除的标签内容关键词列表"
    )
    parser.add_argument(
        "--class-mapping",
        type=str,
